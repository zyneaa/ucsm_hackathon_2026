...
import ChallengeHeaderImg from '../assets/GrandChallenge.png';
    ...
    return (
        <div className="w-full pt-8 pb-4 md:py-12">
            <div className="relative left-1/2 -translate-x-1/2 bg-[#ffffff] text-[#0D0B1F] p-8 md:p-20 shadow-2xl rounded-xs flex flex-col items-center text-center w-[90vw]">
                ...
                <div
                    className="w-full relative overflow-hidden mb-8 bg-cover bg-center bg-no-repeat flex flex-col justify-center p-8 md:p-16 h-[300px]"
                    style={{ backgroundImage: `url(${ChallengeHeaderImg})` }}
                >
                    <h2 className="relative z-10 font-serif text-4xl sm:text-5xl lg:text-6xl uppercase tracking-wider text-brand-primary leading-tight">
                        THE GRAND CHALLENGE
                    </h2>
                    <h3 className="relative z-10 font-serif text-3xl sm:text-4xl lg:text-5xl uppercase tracking-wide text-brand-primary mt-1">
                        AI FOR MYANMAR
                    </h3>
                </div>
